...
class RegistroTransporte(models.Model):
   ...
   tipo_atend=models.CharField(verbose_name='Tipo atendimento',max_length=1, choices=TIPO_ATENDIMENTO, null=True, blank=False )
   acompanhante=models.CharField(verbose_name='Tem acompanhante',null=True,blank=False,max_length=1,choices=ACOMPANHANTE)
   atend_zona_rural=models.CharField(verbose_name='Atend. Zona rural',max_length=1,choices=ATEND_ZONA_RURAL)
   origem=models.CharField(verbose_name='Origem',null=True, blank=False, max_length=200, default='SANTO ANTÔNIO DO JACINTO-MG')
   ...
   dist_percorrida=models.PositiveBigIntegerField(verbose_name='Distância percorrida (KM)', null=True, blank=True,help_text='ida e volta')
   quant_proced_paciente=models.PositiveBigIntegerField(verbose_name='Quant. procedimento 08.03.01.012-5',null=True,blank=True,help_text='Paciente')
