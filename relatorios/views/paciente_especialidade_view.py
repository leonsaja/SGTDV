...
def relatorio_paciente_especialidade_pdf(request,context):
    ...
    html_string = render_to_string('especialidade/relatorio_paciente_especialidade_pdf.html',context)
...
def relatorio_pacientes_especialidade(request):
    ...
    return render(request,'especialidade/relatorio_paciente_especialidade.html',{'form':form})