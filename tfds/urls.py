...
urlpatterns = [
     ...
     #Recibo de TFDs
     path("create/recibo-tfd",view_r_t.ReciboTFDCreateView.as_view(),name='add-recibo_tfd'),
     path("update/<int:pk>/recibo-tfd",view_r_t.ReciboTFDUpdateView.as_view(),name='edit-recibo_tfd'),
     path("update/<int:id>/status",view_r_t.reciboStatusUpdate,name='status-recibo-tfd'),
