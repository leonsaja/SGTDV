# Generated by Django 4.2.7 on 2025-07-02 16:50
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('unid_assistencial', models.CharField(blank=True, max_length=240, null=True, verbose_name='Unidade Assistencial')),
                ('tem_acompanhante', models.CharField(choices=[('1', 'SIM'), ('2', 'NÃO')], max_length=1, verbose_name='Tem Acompanhante')),
                ('acompanhante', models.CharField(blank=True, max_length=200, null=True, verbose_name='Acompanhante')),
                ...
                ('cns', models.PositiveBigIntegerField(blank=True, help_text='Digite o cartão do SUS com 15 digitos', null=True, verbose_name='CNS')),
